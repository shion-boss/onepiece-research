...
- **次にやること**: cardrush_1385 (クロコダイル) game 5 を開始 (seed 15)。 g1 W / g2 L / g3 W / g4 L。
- **全体記録**: 1342 = 3勝2敗 (完了)。 1385 = 2勝2敗 (残り1戦)。 残り14デッキ未着手。
...
| 2 | cardrush_1385 | クロコダイル / B・W ミッドレンジ | 2-2 | g1W g2L g3W(逆転) g4L。 ⭐序盤ライフ削られすぎ→終盤2×クロコengineに轢かれる(g2/g4敗因)。 詰めはブースト必須(g3)。 残1戦 |
