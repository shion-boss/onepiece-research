...
- **次にやること**: cardrush_1385 (クロコダイル) game 4 を開始 (seed 14)。 g1 W / g2 L / g3 W。
- **全体記録**: 1342 = 3勝2敗 (完了)。 1385 = 2勝1敗 (残り2戦)。 残り14デッキ未着手。
...
| 2 | cardrush_1385 | クロコダイル / B・W ミッドレンジ | 2-1 | g1 W / g2 L / g3 W(1ライフから逆転)。 ⭐AIの「受動」は溜め。 ⭐g3教訓=詰めはブースト必須(素5000止めがライフ札counter+Mr.5ブロッカーで弾かれ不発)。 完 残2戦 |
