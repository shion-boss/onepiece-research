...
- **次にやること**: **deck 4 = cardrush_1399 の g4 を開始** (seed 新規、 例 34)。 1399 = 3-0 (g1,g2,g3 W)。
- **全体記録**: 1342 = 3-2 (完了)。 1385 = 2-3 (完了)。 1392 = 4-1 (完了)。 **1399 = 3-0 (g1,g2,g3 W、 進行中)**。 残り12デッキ。
