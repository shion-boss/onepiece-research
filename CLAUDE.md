...
> 公式 Q&A 全 1,205 件の conformance ([[project_faq_conformance_routine]]) で **検査済 526 件
> (n/a 58 除く) のうち 88 件 = 約 17% が違反 (fixed)**、 conform 438 件。
...
> **escalated (= 要深掘りで保留) は 0 件** (2026-08-10 にクラウド cron が残した 7 件も全消化)。
> **未処理 621 件 = 全体の 51.5% は未検査**。
