...
### 現在のメタ Tier (matchup matrix, n=20, 2026-05-12 再計算)

R44〜R59 で `_unimplemented = 0` 達成 + audit sev=3-4 = 0 + engine 厳密化 audit 10/10 pass
+ 13+ 新 trigger + 35+ 新 primitive 投入後の reference 値。

| Tier | デッキ |
|---|---|
| **S (85%+)** | (該当なし) |
| **A (75%+)** | 赤黄ボニー (85%) / 青黄ナミ (84%) / 空島ルフィ (77%) / 赤紫ロジャー (75%) |
| **B (50-74%)** | 紫エネル (62%) / 赤青エース (61%) / 緑黄しらほし (58%) / 紫ドフラミンゴ (51%) |
| **C (25-49%)** | 緑ボニー (46%) / 緑ミホーク (37%) |
| **D (<25%)** | 青紫サンジ (20%) / 赤青ルーシー (18%) / 黒イム (17%) / 緑紫ルフィ (13%) / 黒クロコダイル (5%) |

主要変動 (R47 → R59 後):
- 赤黄ボニー +14pt (71→85): 静的効果改善
- 緑黄しらほし +21pt (37→58): replace_leave + 海王類静的バフ実装
- 紫ドフラミンゴ -26pt (77→51): redirect_attack 強化で攻撃寄り AI が動きにくくなった
- 黒イム -15pt (32→17): engine 厳密化で従来の優位消失
- 赤青エース -11pt (72→61): on_attack 拡張で AI 判断変化
