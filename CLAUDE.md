...
> 公式 Q&A 全 1,205 件の conformance ([[project_faq_conformance_routine]]) は
> **2026-08-17 に全件決着 (pending 0 / escalated 0)**: 検査済 1,106 件 (n/a 99 除く) のうち
> **166 件 = 約 15.0% が違反 (fixed)**、 conform 940 件。
...
> 既知の残: 場 5 枚差し替え (3-7-6-1) の **人間の犠牲選択は 7 primitive にのみ適用**
> (halt 点が zone 変更後にある 8 primitive は最弱自動、 `docs/official_rulings.md` 参照)。
>
