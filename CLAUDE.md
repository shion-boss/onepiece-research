...
|---|---|
| **S (85%+)** | (該当なし) |
| **A (75%+)** | 赤紫ロジャー (83%) / 青黄ナミ (82%) / 紫ドフラ (77%) |
| **B (50-74%)** | 空島ルフィ (74%) / 赤青エース (72%) / 赤黄ボニー (71%) / 紫エネル (67%) / 緑ボニー (51%) |
| **C (25-49%)** | 緑黄しらほし (37%) / 緑ミホーク (35%) / 黒イム (32%) |
| **D (<25%)** | 青紫サンジ (23%) / 赤青ルーシー (13%) / 緑紫ルフィ (6%) / 黒クロコ (6%) |

注: アーキタイプ判定を multi-signal scoring に置換 + ai_hint_signals 構造化 + defender の attacker buff 予測を導入した結果、 AI が全体的に「コントロール寄り (= 攻撃控えめ)」になり、 攻撃寄りデッキ (赤青ルーシー / 黒クロコ) が悪化。 ramp/aggro 判定の閾値再調整が継続課題。
